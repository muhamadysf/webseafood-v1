            ...
            <div class="flex items-center mb-4 space-x-2">
                <div class="flex-0">
                    <div class="relative max-w-xs">
                        ...
                        <div class="absolute inset-y-0 flex items-center pointer-events-none start-0 ps-3">
                            <svg class="text-gray-400 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="flex items-center justify-end flex-1 space-x-2">
                    <div id="hs-dropdown-datatable-with-export" class="hs-dropdown [--placement:bottom-right] relative inline-flex">
                        ...
                        <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-32 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)]" role="menu" aria-orientation="vertical" aria-labelledby="hs-datatable-export-dropdown">
                            <div class="p-1 space-y-0.5">
                                <button type="button" class="flex items-center w-full px-3 py-2 text-sm text-gray-800 rounded-lg gap-x-2 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="copy">
                                ...
                                <button type="button" class="flex items-center w-full px-3 py-2 text-sm text-gray-800 rounded-lg gap-x-2 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="print">
                                    <svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div class="p-1 space-y-0.5 border-t border-gray-200">
                                <button type="button" class="flex items-center w-full px-3 py-2 text-sm text-gray-800 rounded-lg gap-x-2 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="excel">
                                ...
                                <button type="button" class="flex items-center w-full px-3 py-2 text-sm text-gray-800 rounded-lg gap-x-2 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="csv">
                                ...
                                <button type="button" class="flex items-center w-full px-3 py-2 text-sm text-gray-800 rounded-lg gap-x-2 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" data-hs-datatable-action-type="pdf">
                        ...
                        <table class="min-w-full">
                            <thead class="border-b border-gray-200">
                                <tr>
                                    ...
                                    <th scope="col" class="px-3 py-2 text-sm font-normal text-gray-500 text-end --exclude-from-ordering">Action</th>
                                </tr>
                            </thead>

                            <tbody class="divide-y divide-gray-200">
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Christina Bersh</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">45</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">4222 River Rd, Columbus</td>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">David Harrison</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">27</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">2952 S Peoria Ave, Tulsa</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Anne Richard</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">31</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">255 Dock Ln, New Tazewell</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Samia Kartoon</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">45</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">4970 Park Ave W, Ohio</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Brian Halligan</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">31</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">2952 S Peoria Ave, Tulsa</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Andy Clerk</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">45</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">1818 H St NW, Washington</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Bart Simpson</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">27</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">3 Grace Dr, New Mexico</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Camila Welters</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">45</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">4531 W Saile Dr, North Dakota</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Oliver Schevich</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">27</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">2126 N Eagle, Meridian, Illinois</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Inna Ivy</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">31</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">3817 Beryl Rd, Nebraska</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Jessica Williams</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">27</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">4807 3rd Ave, New Hampshire</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">James Collins</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">31</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">Melbourne No. 1 Lake Park</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Costa Quinn</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">27</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">New York No. 1 Lake Park</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Jim Green</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">27</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">LA No. 1 Lake Park</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Joe Black</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">31</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">Sidney No. 1 Lake Park</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Isabella Cherry</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">27</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">4222 River Rd, Columbus</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Alex Tacker</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">31</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">2952 S Peoria Ave, Tulsa</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Endy Ruiz</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">45</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">1818 H St NW, Washington</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
                                ...
                                <tr>
                                    <td class="p-3 text-sm font-medium text-gray-800 whitespace-nowrap">Jack Li</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">27</td>
                                    <td class="p-3 text-sm text-gray-800 whitespace-nowrap">3 Grace Dr, New Mexico</td>
                                    <td class="p-3 text-sm font-medium whitespace-nowrap text-end">
                                        <button type="button" class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 focus:outline-none focus:text-blue-800 disabled:opacity-50 disabled:pointer-events-none">Delete</button>
    ...
    <script>
        window.addEventListener('load', () => {
            ...
            (function() {
                const {
                    dataTable
                } = new HSDataTable('#hs-datatable-with-export');
